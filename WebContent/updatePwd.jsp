 ...
 <table border="0" cellpadding="0" cellspacing="0" width="300">  <!-- 调整表格位置 -->
  ...
  <div class="jive-table">
                <table summary="List of threads" cellpadding="0" cellspacing="0" width="100%">    <!-- 调整表格颜色等格式 -->
                  <thead>
                    <tr>
                      <th width="83%" class="jive-first">修改密码</th>
                    </tr>
                  </thead>
                  <tbody>
                 ...
                 <%System.out.println(name); %>
                    <tr class="jive-odd">
                      <td class="jive-thread-name"><div align="center">新密 码：
                    ...
                    <tr class="jive-odd">
                      <td class="jive-thread-name"><div align="center">确认新密 码：
