...
sql = "select title,content,date,user,dsc,tpcid from "+tableName+" order by date desc";
				  ...
				  <tbody>
					<tr>
					  <td>
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
						  <tbody>
							<tr valign="top">
							  ...
							  <td style="padding: 0px;" width="99%"><%=rs.getString("user") %>
						...
						<br />
						<span class="jive-description">跟帖数: <%=rs.getString("dsc")%><br />
						<br>
						<a href="deletePostFl.jsp?tpcid=<%=id[i]%>"> 删除该帖</a>
</span>
					  </td>
					</tr>
				  </tbody>
