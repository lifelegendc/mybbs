...
<%
	...
	if(!insert_password.equals(insert_password_again)){
		...
		out.println("<a href='adminReg.jsp'>点击这里重新注册吧</a><br>");
		out.println("</div>");
		return;
	}
...
{   out.println("<div align=\"center\">");
	...
	sql="insert into "+tableName+"(adminname,password,gender,email,findQ,findA) values('"+insert_name+"','"+insert_password+"','"+insert_gender+"','"+insert_email+"','"+insert_findQ+"','"+insert_findA+"')";
...
out.println("<a href='adminLogin.jsp'>点击这里登录吧</a><br>");
out.println("</div>");
